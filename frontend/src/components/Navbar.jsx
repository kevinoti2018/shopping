...
const Navbar = () => {
  return (
    ...
    <div className='n-row'>
        ...
        <div className='n-col'>
            <span className='n-email'>kelvinotix@gmail.com</span>
            <span><FontAwesomeIcon icon={faUser}/>Guest </span>
            </div>
        <div className='n-col'>
            <div className='socials'>
               <a href=''> <img src="/images/socials/fb.png"alt='facebok'/></a>
               <a href=''> <img src="/images/socials/ig.png"alt='instagram'/></a>
               <a href=''> <img src="/images/socials/twitter.png"alt='twitter'/></a>
               <a href=''> <img src="/images/socials/youtube.png"alt='youtube'/></a>
            </div>
        </div>
    </div>
    <div className='n-row'>
    <div className='n-col'>
    <a href='/'><img src='/images/logo/logo.png' alt='logo' className='logo'/></a>
    </div>
    <div className='n-col'>
        <div className='icons'>
